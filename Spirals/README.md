...
<br><br>
Another kind of spiral is the [evolvent](https://proofwiki.org/wiki/Parametric_Equation_of_Involute_of_Circle), a.k.a. involute (Dutch: 'wikkellijn, afwikkelkromme'). It can be constructed by the end of an unwinding string wound around a cilinder.
